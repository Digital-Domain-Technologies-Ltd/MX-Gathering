...
1. **Provide Strategic Context:** Define the blog post purpose, target audience, and key messages
2. **Supply Source Material:** Share relevant chapters, patterns, or technical specifications
3. **Set Boundaries:** Specify what NOT to include (out of scope, future speculation, unverified claims)
4. **Review Critically:** AI-generated content requires human verification for accuracy and tone
5. **Iterate Freely:** Collaboration benefits from multiple revision cycles
...
- Strategic direction: Tom Cranstoun ([tom.cranstoun@gmail.com](mailto:tom.cranstoun@gmail.com))
- Technical questions: Reference source material in MX-Bible or MX-Handbook
